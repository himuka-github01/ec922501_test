...
use Customize\Entity\Order; //来店受取日設定用　2024/11/15 田中
...
use Symfony\Component\Form\Extension\Core\Type\DateTimeType;//　来店受取日設定用　2024/11/15 田中
...
class OrderTypeExtension extends AbstractTypeExtension
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        ...
        $builder
            ...
            ->add('Ukedate', DateTimeType::class, [
                'widget' => 'single_text',
                'format' => 'yyyy-MM-dd',
                'required' => false,
                'mapped' => false,
