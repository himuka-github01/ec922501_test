...
class __TwigTemplate_ec4c9bbfa738f7a815f639e2a734dafd3699c1cd467199617373759208bac4ba extends \Eccube\Twig\Template
{
    private $source;
    private $macros = [];
...
<table border=\"0\" width=\"100%\" height=\"100%\" cellpadding=\"0\" cellspacing=\"0\" bgcolor=\"#F0F0F0\" style=\"border-spacing:0;mso-table-lspace:0pt;mso-table-rspace:0pt;\">
    <tr>
        ...
        // line 117
        echo "                            ";
        if ( !twig_test_empty(twig_get_attribute($this->env, $this->source, ($context["Order"] ?? null), "complete_mail_message", [], "any", false, false, false, 117))) {
            // line 118
            echo "                                ";
            echo nl2br(twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, ($context["Order"] ?? null), "complete_mail_message", [], "any", false, false, false, 118), "html", null, true));
            echo "<br/>
                            ";
        }
        // line 120
            ...
            <table id=\"html-mail-table2\" border=\"0\" width=\"600px\" cellpadding=\"10\" cellspacing=\"0\" class=\"container\" style=\"border-spacing:0;mso-table-lspace:0pt;mso-table-rspace:0pt;\">
                <tr>
                    <td class=\"container-padding content footer-text\" align=\"left\" style=\"border-collapse:collapse;font-family:Helvetica, Arial, sans-serif;font-size:12px;line-height:16px;color:#aaaaaa;padding-left:24px;padding-right:24px;padding-top:12px;padding-bottom:12px;background-color:#ffffff;\">
                        本メールは、";
        // line 134
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, ($context["BaseInfo"] ?? null), "shop_name", [], "any", false, false, false, 134), "html", null, true);
        echo "より送信しております。<br/>
                        もしお心当たりが無い場合は、その旨 <a href=\"mailto:";
        // line 135
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, ($context["BaseInfo"] ?? null), "email02", [], "any", false, false, false, 135), "html", null, true);
        ...
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, ($context["BaseInfo"] ?? null), "shop_name", [], "any", false, false, false, 137), "html", null, true);
        echo "</a></div>
                        <div>copyright &copy; ";
        // line 138
...
";
    ...
    {
        return array (  417 => 138,  411 => 137,  404 => 135,  400 => 134,  384 => 120,  378 => 118,  375 => 117,  361 => 116,  352 => 113,  344 => 112,  339 => 111,  335 => 110,  330 => 108,  326 => 107,  322 => 106,  317 => 104,  312 => 103,  306 => 101,  304 => 100,  298 => 99,  292 => 98,  284 => 96,  267 => 95,  258 => 89,  254 => 88,  249 => 87,  243 => 85,  241 => 84,  235 => 83,  229 => 82,  221 => 77,  218 => 76,  208 => 74,  205 => 73,  200 => 72,  189 => 70,  185 => 69,  181 => 68,  178 => 67,  172 => 65,  170 => 64,  166 => 63,  162 => 62,  158 => 61,  155 => 60,  150 => 59,  141 => 56,  137 => 55,  125 => 54,  120 => 53,  115 => 52,  113 => 51,  104 => 46,  99 => 44,  94 => 43,  92 => 42,  88 => 41,  84 => 40,  80 => 39,  76 => 38,  64 => 31,  45 => 17,  37 => 11,);
    }

    public function getSourceContext()
    {
        return new Source("", "Mail/order.html.twig", "/var/www/htdocs/ec922501/src/Eccube/Resource/template/default/Mail/order.html.twig");
    }
}
