...
/* __string_template__035d10c87ed8c836c2404b6a20246946948e04fd5535a3df01301cb1d9952fa3 */
class __TwigTemplate_b3c0360739982393c3a39dbe30032834a1b237956defd6fc830e63653505bca8 extends \Eccube\Twig\Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        // line 11
        $this->parent = $this->loadTemplate("@admin/default_frame.twig", "__string_template__035d10c87ed8c836c2404b6a20246946948e04fd5535a3df01301cb1d9952fa3", 11);
...
";
    ...
    <form name=\"form1\" id=\"form1\" method=\"post\" action=\"?\"";
        ...
        echo twig_include($this->env, $context, "@ProductOption/admin/Order/order_item_prototype.twig", ["orderItemForm" => twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["form"] ?? null), "OrderItems", [], "any", false, false, false, 799), "vars", [], "any", false, false, false, 799), "prototype", [], "any", false, false, false, 799)]);
        $___internal_b0855ba4e416fbf3f3722b3cb94d68daf0da7de21a1d6b42d29256d06f25ca4a_ = ('' === $tmp = ob_get_clean()) ? '' : new Markup($tmp, $this->env->getCharset());
        echo twig_escape_filter($this->env, $___internal_b0855ba4e416fbf3f3722b3cb94d68daf0da7de21a1d6b42d29256d06f25ca4a_);
        echo "\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["orderItemForm"]) {
            ...
            if ((twig_get_attribute($this->env, $this->source, ($context["OrderItem"] ?? null), "isProduct", [], "any", false, false, false, 833) || twig_get_attribute($this->env, $this->source, ($context["OrderItem"] ?? null), "isPoint", [], "any", false, false, false, 833))) {
                ...
                if (twig_get_attribute($this->env, $this->source, ($context["OrderItem"] ?? null), "isProduct", [], "any", false, false, false, 834)) {
                    ...
                    echo twig_include($this->env, $context, "@ProductOption/admin/Order/orderitem_option.twig");
                    echo "
                                                            </a>
                                                        ";
                } else {
                ...
                echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, $context["orderItemForm"], "option_serial", [], "any", false, false, false, 841), 'widget', ["type" => "hidden"]);
                echo "
                                                    ";
            } else {
                // line 843
...
";
    ...
    {
        return "__string_template__035d10c87ed8c836c2404b6a20246946948e04fd5535a3df01301cb1d9952fa3";
    }
