...
class __TwigTemplate_25580cb7346308f20a3513705b443af0aa592d62cb2d014017b51c576ca3e8d1 extends \Eccube\Twig\Template
{
    private $source;
    private $macros = [];
    ...
    if (\$('[type=\"date\"]').prop('type') !== 'date') {
        ...
        echo "\").done(function() {
                    \$('input[type=date]').datetimepicker({
                        locale: '";
        // line 34
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, ($context["eccube_config"] ?? null), "locale", [], "any", false, false, false, 34), "html", null, true);
        echo "',
                        format: 'YYYY-MM-DD',
                        useCurrent: false,
                        buttons: {
...
\$(function() {
    ";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["ProductOption"]) {
            ...
            // line 53
            echo "        ";
            if ((twig_get_attribute($this->env, $this->source, ($context["Option"] ?? null), "description_flg", [], "any", false, false, false, 53) == twig_constant("Plugin\\ProductOption\\Entity\\OptionCategory::ON"))) {
                // line 54
                echo "            modal";
                echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, ($context["Product"] ?? null), "id", [], "any", false, false, false, 54), "html", null, true);
                echo "_";
                echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, ($context["Option"] ?? null), "id", [], "any", false, false, false, 54), "html", null, true);
            ...
            \$('#option_description_link_";
                ...
                echo "_";
                echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, ($context["Option"] ?? null), "id", [], "any", false, false, false, 55), "html", null, true);
                echo "').click(function() {
                modal";
                // line 56
                ...
                echo "_";
                echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, ($context["Option"] ?? null), "id", [], "any", false, false, false, 56), "html", null, true);
...
var optionPrice = ";
        // line 108
        echo json_encode(($context["optionPrices"] ?? null));
        echo ";
var optionPoint = ";
        // line 109
        echo json_encode(($context["optionPoints"] ?? null));
        echo ";
var optionMultiple = ";
        // line 110
        echo json_encode(($context["optionMultiples"] ?? null));
        echo ";
var taxRules = ";
        // line 111
        echo json_encode(($context["taxRules"] ?? null));
        echo ";
var default_class_id = ";
        // line 112
        echo json_encode(($context["default_class_id"] ?? null));
        echo ";
...
";
    ...
    {
        return array (  341 => 222,  334 => 218,  327 => 214,  222 => 112,  218 => 111,  214 => 110,  210 => 109,  206 => 108,  158 => 62,  152 => 61,  142 => 56,  136 => 55,  125 => 54,  122 => 53,  119 => 52,  116 => 51,  112 => 50,  93 => 34,  88 => 32,  84 => 31,  80 => 30,  71 => 25,  67 => 24,  52 => 12,  48 => 11,  44 => 24,  42 => 11,  39 => 10,);
    }

    public function getSourceContext()
    {
        return new Source("", "@ProductOption/default/Product/option_js.twig", "/var/www/htdocs/ec922501/app/Plugin/ProductOption/Resource/template/default/Product/option_js.twig");
    }
}
