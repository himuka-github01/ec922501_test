...
// Returns the public 'Plugin\ProductOption\Controller\Admin\ConfigController' shared autowired service.
...
include_once $this->targetDirs[3].'/app/Plugin/ProductOption/Controller/Admin/ConfigController.php';

$this->services['Plugin\\ProductOption\\Controller\\Admin\\ConfigController'] = $instance = new \Plugin\ProductOption\Controller\Admin\ConfigController(${($_ = isset($this->services['Plugin\\ProductOption\\Repository\\ConfigRepository']) ? $this->services['Plugin\\ProductOption\\Repository\\ConfigRepository'] : $this->load('getConfigRepositoryService.php')) && false ?: '_'});
