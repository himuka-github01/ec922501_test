 ...
 */
class ProductOption extends \Plugin\ProductOption\Entity\ProductOption implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Plugin\\ProductOption\\Entity\\ProductOption' . "\0" . 'checked', '' . "\0" . 'Plugin\\ProductOption\\Entity\\ProductOption' . "\0" . 'id', '' . "\0" . 'Plugin\\ProductOption\\Entity\\ProductOption' . "\0" . 'sort_no', '' . "\0" . 'Plugin\\ProductOption\\Entity\\ProductOption' . "\0" . 'Product', '' . "\0" . 'Plugin\\ProductOption\\Entity\\ProductOption' . "\0" . 'Option'];
        }
