 ...
 */
class ProductOptionConfig extends \Plugin\ProductOption\Entity\ProductOptionConfig implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Plugin\\ProductOption\\Entity\\ProductOptionConfig' . "\0" . 'name', '' . "\0" . 'Plugin\\ProductOption\\Entity\\ProductOptionConfig' . "\0" . 'value'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ProductOptionConfig $proxy) {
