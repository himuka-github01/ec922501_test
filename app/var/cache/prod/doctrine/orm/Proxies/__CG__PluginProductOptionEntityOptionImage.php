 ...
 */
class OptionImage extends \Plugin\ProductOption\Entity\OptionImage implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Plugin\\ProductOption\\Entity\\OptionImage' . "\0" . 'id', '' . "\0" . 'Plugin\\ProductOption\\Entity\\OptionImage' . "\0" . 'file_name', '' . "\0" . 'Plugin\\ProductOption\\Entity\\OptionImage' . "\0" . 'sort_no', '' . "\0" . 'Plugin\\ProductOption\\Entity\\OptionImage' . "\0" . 'create_date', '' . "\0" . 'Plugin\\ProductOption\\Entity\\OptionImage' . "\0" . 'OptionCategory', '' . "\0" . 'Plugin\\ProductOption\\Entity\\OptionImage' . "\0" . 'Creator'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (OptionImage $proxy) {
    ...
    public function setOptionCategory(\Plugin\ProductOption\Entity\OptionCategory $optionCategory = NULL)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setOptionCategory', [$optionCategory]);

        return parent::setOptionCategory($optionCategory);
    }
    ...
    public function getOptionCategory()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getOptionCategory', []);

        return parent::getOptionCategory();
    }
