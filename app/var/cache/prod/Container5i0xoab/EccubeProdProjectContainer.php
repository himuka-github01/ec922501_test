...
class EccubeProdProjectContainer extends Container
{
    ...
    public function __construct(array $buildParameters = [], $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            ...
            'security.request_matcher.ufdnuxm' => 'getSecurity_RequestMatcher_UfdnuxmService.php',
        ...
        $this->privates = [
            ...
            'security.request_matcher.ufdnuxm' => true,
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        $a->addEventSubscriber(new \Plugin\ProductOption\Doctrine\EventSubscriber\CartItemEventSubscriber(${($_ = isset($this->services['Eccube\\Service\\TaxRuleService']) ? $this->services['Eccube\\Service\\TaxRuleService'] : $this->getTaxRuleServiceService()) && false ?: '_'}));
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $g = new \Eccube\Doctrine\ORM\Mapping\Driver\AnnotationDriver($e, [0 => ($this->targetDirs[3].'/app/Plugin/EntityExtension/Entity')]);
        $g->setTraitProxiesDirectory(($this->targetDirs[3].'/app/proxy/entity'));
        $h = new \Eccube\Doctrine\ORM\Mapping\Driver\AnnotationDriver($e, [0 => ($this->targetDirs[3].'/app/Plugin/EntityForm/Entity')]);
        $h->setTraitProxiesDirectory(($this->targetDirs[3].'/app/proxy/entity'));
        $i = new \Eccube\Doctrine\ORM\Mapping\Driver\AnnotationDriver($e, [0 => ($this->targetDirs[3].'/app/Plugin/MigrationSample/Entity')]);
        $i->setTraitProxiesDirectory(($this->targetDirs[3].'/app/proxy/entity'));
        $j = new \Eccube\Doctrine\ORM\Mapping\Driver\AnnotationDriver($e, [0 => ($this->targetDirs[3].'/app/Plugin/ProductOption/Entity')]);
        ...
        $d->addDriver($g, 'Plugin\\EntityExtension\\Entity');
        $d->addDriver($h, 'Plugin\\EntityForm\\Entity');
        $d->addDriver($i, 'Plugin\\MigrationSample\\Entity');
        $d->addDriver($j, 'Plugin\\ProductOption\\Entity');
    ...
    protected function getTwigService()
    {
        ...
        $c = ${($_ = isset($this->services['Eccube\\Repository\\TaxRuleRepository']) ? $this->services['Eccube\\Repository\\TaxRuleRepository'] : $this->getTaxRuleRepositoryService()) && false ?: '_'};
        ...
        $instance->addExtension(new \Customize\Twig\Extension\TaxExtension($c, new \Customize\Service\TaxRuleService($c, ${($_ = isset($this->services['Eccube\\Repository\\BaseInfoRepository']) ? $this->services['Eccube\\Repository\\BaseInfoRepository'] : $this->getBaseInfoRepositoryService()) && false ?: '_'}), $d));
    ...
    protected function getSecurity_FirewallService()
    {
        return $this->services['security.firewall'] = new \Symfony\Bundle\SecurityBundle\EventListener\FirewallListener(new \Symfony\Bundle\SecurityBundle\Security\FirewallMap(new \Symfony\Component\DependencyInjection\ServiceLocator(['security.firewall.map.context.admin' => function () {
            ...
            yield 'security.firewall.map.context.admin' => ${($_ = isset($this->services['security.request_matcher.ufdnuxm']) ? $this->services['security.request_matcher.ufdnuxm'] : ($this->services['security.request_matcher.ufdnuxm'] = new \Symfony\Component\HttpFoundation\RequestMatcher('^/'.$this->getEnv('string:ECCUBE_ADMIN_ROUTE').'/'))) && false ?: '_'};
