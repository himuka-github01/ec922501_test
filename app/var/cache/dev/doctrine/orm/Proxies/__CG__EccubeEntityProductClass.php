...
class ProductClass extends \Eccube\Entity\ProductClass implements \Doctrine\ORM\Proxy\Proxy
{
  ...
  3 => 'AnnotationReader',
    ...
    public function getOneDayLimit(): ?string
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getOneDayLimit', []);

        return parent::getOneDayLimit();
    }

    /**
     * {@inheritDoc}
     */
    public function setOneDayLimit(?string $one_day_limit): \Eccube\Entity\ProductClass
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setOneDayLimit', [$one_day_limit]);

        return parent::setOneDayLimit($one_day_limit);
    }
