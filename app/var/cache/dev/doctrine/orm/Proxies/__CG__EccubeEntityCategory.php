...
class Category extends \Eccube\Entity\Category implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Eccube\\Entity\\Category' . "\0" . 'id', '' . "\0" . 'Eccube\\Entity\\Category' . "\0" . 'name', '' . "\0" . 'Eccube\\Entity\\Category' . "\0" . 'hierarchy', '' . "\0" . 'Eccube\\Entity\\Category' . "\0" . 'sort_no', '' . "\0" . 'Eccube\\Entity\\Category' . "\0" . 'create_date', '' . "\0" . 'Eccube\\Entity\\Category' . "\0" . 'update_date', '' . "\0" . 'Eccube\\Entity\\Category' . "\0" . 'ProductCategories', '' . "\0" . 'Eccube\\Entity\\Category' . "\0" . 'Children', '' . "\0" . 'Eccube\\Entity\\Category' . "\0" . 'Parent', '' . "\0" . 'Eccube\\Entity\\Category' . "\0" . 'Creator', '' . "\0" . 'Eccube\\Entity\\Category' . "\0" . 'dispStartDt', '' . "\0" . 'Eccube\\Entity\\Category' . "\0" . 'dispEndDt', '' . "\0" . 'Eccube\\Entity\\Category' . "\0" . 'saijiCd', '' . "\0" . 'Eccube\\Entity\\Category' . "\0" . 'deliveryStartDt', '' . "\0" . 'Eccube\\Entity\\Category' . "\0" . 'deliveryEndDt', '' . "\0" . 'Eccube\\Entity\\Category' . "\0" . 'wari_a_value', '' . "\0" . 'Eccube\\Entity\\Category' . "\0" . 'wari_b_value', '' . "\0" . 'Eccube\\Entity\\Category' . "\0" . 'wari_kikan_value', '' . "\0" . 'Eccube\\Entity\\Category' . "\0" . 'wari_kikan_end_dt', '' . "\0" . 'Eccube\\Entity\\Category' . "\0" . 'SaijiTenpos'];
        }
  ...
  3 => 'AnnotationReader',
    ...
    public function getDispStartDt()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getDispStartDt', []);

        return parent::getDispStartDt();
    }
    ...
    public function setDispStartDt($dispStartDt)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setDispStartDt', [$dispStartDt]);

        return parent::setDispStartDt($dispStartDt);
    }
    ...
    public function getDispEndDt()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getDispEndDt', []);

        return parent::getDispEndDt();
    }
    ...
    public function setDispEndDt($dispEndDt)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setDispEndDt', [$dispEndDt]);

        return parent::setDispEndDt($dispEndDt);
    }
    ...
    public function setSaijiCd($saijiCd)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setSaijiCd', [$saijiCd]);

        return parent::setSaijiCd($saijiCd);
    }
    ...
    public function getDeliveryStartDt()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getDeliveryStartDt', []);

        return parent::getDeliveryStartDt();
    }
    ...
    public function setDeliveryStartDt($deliveryStartDt)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setDeliveryStartDt', [$deliveryStartDt]);

        return parent::setDeliveryStartDt($deliveryStartDt);
    }
    ...
    public function getDeliveryEndDt()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getDeliveryEndDt', []);

        return parent::getDeliveryEndDt();
    }
    ...
    public function setDeliveryEndDt($deliveryEndDt)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setDeliveryEndDt', [$deliveryEndDt]);

        return parent::setDeliveryEndDt($deliveryEndDt);
    }
     ...
     * {@inheritDoc}
     */
    public function setWariAValue(?string $wari_a_value): \Eccube\Entity\Category
    {
     ...
     * {@inheritDoc}
     */
    public function setWariBValue(?string $wari_b_value): \Eccube\Entity\Category
    {
     ...
     * {@inheritDoc}
     */
    public function setWariKikanValue(?string $wari_kikan_value): \Eccube\Entity\Category
    {
     ...
     * {@inheritDoc}
     */
    public function setWariKikanEndDt(?\DateTimeInterface $wari_kikan_end_dt): \Eccube\Entity\Category
    {
