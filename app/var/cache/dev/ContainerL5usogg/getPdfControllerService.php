...
// Returns the public 'Plugin\ProductOption\Controller\Admin\PdfController' shared autowired service.
...
include_once $this->targetDirs[3].'/app/Plugin/ProductOption/Controller/Admin/PdfController.php';

$this->services['Plugin\\ProductOption\\Controller\\Admin\\PdfController'] = $instance = new \Plugin\ProductOption\Controller\Admin\PdfController(${($_ = isset($this->services['Eccube\\Repository\\OrderPdfRepository']) ? $this->services['Eccube\\Repository\\OrderPdfRepository'] : $this->load('getOrderPdfRepositoryService.php')) && false ?: '_'});
