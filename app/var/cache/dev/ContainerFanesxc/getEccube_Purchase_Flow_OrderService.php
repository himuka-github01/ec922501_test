...
$this->services['eccube.purchase.flow.order'] = $instance = new \Customize\Service\PurchaseFlow\PurchaseFlow();
...
$instance->setItemPreprocessors(${($_ = isset($this->services['eccube.purchase.flow.order.item_preprocessors']) ? $this->services['eccube.purchase.flow.order.item_preprocessors'] : $this->load('getEccube_Purchase_Flow_Order_ItemPreprocessorsService.php')) && false ?: '_'});
