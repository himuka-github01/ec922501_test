...
return $this->services['form.registry'] = new \Symfony\Component\Form\FormRegistry([0 => new \Symfony\Component\Form\Extension\DependencyInjection\DependencyInjectionExtension(new \Symfony\Component\DependencyInjection\ServiceLocator(['Customize\\Form\\Type\\HdnSelectSaijiBlockType' => function () {
    return ${($_ = isset($this->services['Customize\\Form\\Type\\HdnSelectSaijiBlockType']) ? $this->services['Customize\\Form\\Type\\HdnSelectSaijiBlockType'] : $this->load('getHdnSelectSaijiBlockTypeService.php')) && false ?: '_'};
}, 'Customize\\Form\\Type\\HdnSelectTenpoBlockType' => function () {
    return ${($_ = isset($this->services['Customize\\Form\\Type\\HdnSelectTenpoBlockType']) ? $this->services['Customize\\Form\\Type\\HdnSelectTenpoBlockType'] : $this->load('getHdnSelectTenpoBlockTypeService.php')) && false ?: '_'};
}, 'Eccube\\Form\\Type\\AddCartType' => function () {
...
}, 'Eccube\\Form\\Type\\Admin\\OrderStatusSettingType' => function () {
    return ${($_ = isset($this->services['Eccube\\Form\\Type\\Admin\\OrderStatusSettingType']) ? $this->services['Eccube\\Form\\Type\\Admin\\OrderStatusSettingType'] : $this->load('getOrderStatusSettingTypeService.php')) && false ?: '_'};
...
}, 'Plugin\\ProductOption\\Form\\Type\\Admin\\ConfigType' => function () {
    return ${($_ = isset($this->services['Plugin\\ProductOption\\Form\\Type\\Admin\\ConfigType']) ? $this->services['Plugin\\ProductOption\\Form\\Type\\Admin\\ConfigType'] : ($this->services['Plugin\\ProductOption\\Form\\Type\\Admin\\ConfigType'] = new \Plugin\ProductOption\Form\Type\Admin\ConfigType())) && false ?: '_'};
}, 'Plugin\\ProductOption\\Form\\Type\\Admin\\OptionCategoryType' => function () {
    return ${($_ = isset($this->services['Plugin\\ProductOption\\Form\\Type\\Admin\\OptionCategoryType']) ? $this->services['Plugin\\ProductOption\\Form\\Type\\Admin\\OptionCategoryType'] : $this->load('getOptionCategoryTypeService.php')) && false ?: '_'};
}, 'Plugin\\ProductOption\\Form\\Type\\Admin\\OptionTextCategoryType' => function () {
    return ${($_ = isset($this->services['Plugin\\ProductOption\\Form\\Type\\Admin\\OptionTextCategoryType']) ? $this->services['Plugin\\ProductOption\\Form\\Type\\Admin\\OptionTextCategoryType'] : $this->load('getOptionTextCategoryTypeService.php')) && false ?: '_'};
}, 'Plugin\\ProductOption\\Form\\Type\\Admin\\OptionType' => function () {
    return ${($_ = isset($this->services['Plugin\\ProductOption\\Form\\Type\\Admin\\OptionType']) ? $this->services['Plugin\\ProductOption\\Form\\Type\\Admin\\OptionType'] : ($this->services['Plugin\\ProductOption\\Form\\Type\\Admin\\OptionType'] = new \Plugin\ProductOption\Form\Type\Admin\OptionType())) && false ?: '_'};
}, 'Plugin\\ProductOption\\Form\\Type\\Admin\\ProductOptionDesignType' => function () {
    return ${($_ = isset($this->services['Plugin\\ProductOption\\Form\\Type\\Admin\\ProductOptionDesignType']) ? $this->services['Plugin\\ProductOption\\Form\\Type\\Admin\\ProductOptionDesignType'] : ($this->services['Plugin\\ProductOption\\Form\\Type\\Admin\\ProductOptionDesignType'] = new \Plugin\ProductOption\Form\Type\Admin\ProductOptionDesignType())) && false ?: '_'};
}, 'Plugin\\ProductOption\\Form\\Type\\Admin\\ProductOptionType' => function () {
    return ${($_ = isset($this->services['Plugin\\ProductOption\\Form\\Type\\Admin\\ProductOptionType']) ? $this->services['Plugin\\ProductOption\\Form\\Type\\Admin\\ProductOptionType'] : ($this->services['Plugin\\ProductOption\\Form\\Type\\Admin\\ProductOptionType'] = new \Plugin\ProductOption\Form\Type\Admin\ProductOptionType())) && false ?: '_'};
    ...
    yield 7 => ${($_ = isset($this->services['form.type_extension.form.data_collector']) ? $this->services['form.type_extension.form.data_collector'] : $this->load('getForm_TypeExtension_Form_DataCollectorService.php')) && false ?: '_'};
}, 8), 'Eccube\\Form\\Type\\AddCartType' => new RewindableGenerator(function () {
    yield 0 => ${($_ = isset($this->services['Plugin\\ProductOption\\Form\\Extension\\AddCartExtension']) ? $this->services['Plugin\\ProductOption\\Form\\Extension\\AddCartExtension'] : $this->load('getAddCartExtensionService.php')) && false ?: '_'};
    yield 1 => ${($_ = isset($this->services['Customize\\Form\\Extension\\AddCartTypeExtension']) ? $this->services['Customize\\Form\\Extension\\AddCartTypeExtension'] : $this->load('getAddCartTypeExtensionService.php')) && false ?: '_'};
}, 2), 'Eccube\\Form\\Type\\Admin\\OrderItemType' => new RewindableGenerator(function () {
    yield 0 => ${($_ = isset($this->services['Plugin\\ProductOption\\Form\\Extension\\Admin\\OrderItemExtension']) ? $this->services['Plugin\\ProductOption\\Form\\Extension\\Admin\\OrderItemExtension'] : $this->load('getOrderItemExtensionService.php')) && false ?: '_'};
}, 1), 'Eccube\\Form\\Type\\ShippingMultipleType' => new RewindableGenerator(function () {
    yield 0 => ${($_ = isset($this->services['Plugin\\ProductOption\\Form\\Extension\\ShippingMultipleExtension']) ? $this->services['Plugin\\ProductOption\\Form\\Extension\\ShippingMultipleExtension'] : $this->load('getShippingMultipleExtensionService.php')) && false ?: '_'};
}, 1), 'Eccube\\Form\\Type\\ShippingMultipleItemType' => new RewindableGenerator(function () {
    yield 0 => ${($_ = isset($this->services['Plugin\\ProductOption\\Form\\Extension\\ShippingMultipleItemExtension']) ? $this->services['Plugin\\ProductOption\\Form\\Extension\\ShippingMultipleItemExtension'] : ($this->services['Plugin\\ProductOption\\Form\\Extension\\ShippingMultipleItemExtension'] = new \Plugin\ProductOption\Form\Extension\ShippingMultipleItemExtension())) && false ?: '_'};
}, 1), 'Eccube\\Form\\Type\\Admin\\CategoryType' => new RewindableGenerator(function () {
    yield 0 => ${($_ = isset($this->services['Customize\\Form\\Extension\\Admin\\CategoryTypeExtension']) ? $this->services['Customize\\Form\\Extension\\Admin\\CategoryTypeExtension'] : $this->load('getCategoryTypeExtensionService.php')) && false ?: '_'};
}, 1), 'Eccube\\Form\\Type\\Admin\\OrderType' => new RewindableGenerator(function () {
    yield 0 => ${($_ = isset($this->services['Customize\\Form\\Extension\\Admin\\OrderTypeExtension']) ? $this->services['Customize\\Form\\Extension\\Admin\\OrderTypeExtension'] : $this->load('getOrderTypeExtensionService.php')) && false ?: '_'};
}, 1), 'Eccube\\Form\\Type\\Admin\\ProductClassEditType' => new RewindableGenerator(function () {
    yield 0 => ${($_ = isset($this->services['Customize\\Form\\Extension\\Admin\\ProductClassEditTypeExtension']) ? $this->services['Customize\\Form\\Extension\\Admin\\ProductClassEditTypeExtension'] : $this->load('getProductClassEditTypeExtensionService.php')) && false ?: '_'};
}, 1), 'Eccube\\Form\\Type\\Admin\\ProductClassType' => new RewindableGenerator(function () {
    yield 0 => ${($_ = isset($this->services['Customize\\Form\\Extension\\Admin\\ProductClassTypeExtension']) ? $this->services['Customize\\Form\\Extension\\Admin\\ProductClassTypeExtension'] : $this->load('getProductClassTypeExtensionService.php')) && false ?: '_'};
}, 1), 'Eccube\\Form\\Type\\Admin\\ProductType' => new RewindableGenerator(function () {
    yield 0 => ${($_ = isset($this->services['Customize\\Form\\Extension\\Admin\\ProductTypeExtension']) ? $this->services['Customize\\Form\\Extension\\Admin\\ProductTypeExtension'] : $this->load('getProductTypeExtensionService.php')) && false ?: '_'};
}, 1), 'Eccube\\Form\\Type\\Admin\\SearchOrderType' => new RewindableGenerator(function () {
    yield 0 => ${($_ = isset($this->services['Customize\\Form\\Extension\\Admin\\SearchOrderTypeExtension']) ? $this->services['Customize\\Form\\Extension\\Admin\\SearchOrderTypeExtension'] : $this->load('getSearchOrderTypeExtensionService.php')) && false ?: '_'};
}, 1), 'Eccube\\Form\\Type\\Admin\\SearchProductType' => new RewindableGenerator(function () {
    yield 0 => ${($_ = isset($this->services['Customize\\Form\\Extension\\Admin\\SearchProductTypeExtension']) ? $this->services['Customize\\Form\\Extension\\Admin\\SearchProductTypeExtension'] : $this->load('getSearchProductTypeExtensionService.php')) && false ?: '_'};
}, 1), 'Eccube\\Form\\Type\\Admin\\ShippingType' => new RewindableGenerator(function () {
    yield 0 => ${($_ = isset($this->services['Customize\\Form\\Extension\\Admin\\ShippingTypeExtension']) ? $this->services['Customize\\Form\\Extension\\Admin\\ShippingTypeExtension'] : $this->load('getShippingTypeExtensionService.php')) && false ?: '_'};
}, 1), 'Eccube\\Form\\Type\\Master\\PaymentType' => new RewindableGenerator(function () {
    yield 0 => ${($_ = isset($this->services['Customize\\Form\\Extension\\Master\\PaymentTypeExtension']) ? $this->services['Customize\\Form\\Extension\\Master\\PaymentTypeExtension'] : ($this->services['Customize\\Form\\Extension\\Master\\PaymentTypeExtension'] = new \Customize\Form\Extension\Master\PaymentTypeExtension())) && false ?: '_'};
}, 1), 'Eccube\\Form\\Type\\Admin\\MasterdataType' => new RewindableGenerator(function () {
    yield 0 => ${($_ = isset($this->services['Customize\\Form\\Extension\\MasterdataTypeExtension']) ? $this->services['Customize\\Form\\Extension\\MasterdataTypeExtension'] : $this->load('getMasterdataTypeExtensionService.php')) && false ?: '_'};
}, 1), 'Eccube\\Form\\Type\\Front\\NonMemberType' => new RewindableGenerator(function () {
    yield 0 => ${($_ = isset($this->services['Customize\\Form\\Extension\\NonMemberTypeExtension']) ? $this->services['Customize\\Form\\Extension\\NonMemberTypeExtension'] : $this->load('getNonMemberTypeExtensionService.php')) && false ?: '_'};
}, 1), 'Eccube\\Form\\Type\\Shopping\\ShippingType' => new RewindableGenerator(function () {
    yield 0 => ${($_ = isset($this->services['Customize\\Form\\Extension\\ShippingTypeExtension']) ? $this->services['Customize\\Form\\Extension\\ShippingTypeExtension'] : $this->load('getShippingTypeExtension2Service.php')) && false ?: '_'};
