...
// Returns the public 'Customize\Controller\Admin\Product\CategoryController' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Eccube/Controller/Admin/Product/CategoryController.php';
include_once $this->targetDirs[3].'/app/Customize/Controller/Admin/Product/CategoryController.php';

$this->services['Customize\\Controller\\Admin\\Product\\CategoryController'] = $instance = new \Customize\Controller\Admin\Product\CategoryController(${($_ = isset($this->services['Eccube\\Service\\CsvExportService']) ? $this->services['Eccube\\Service\\CsvExportService'] : $this->load('getCsvExportServiceService.php')) && false ?: '_'}, ${($_ = isset($this->services['Customize\\Repository\\CategoryRepository']) ? $this->services['Customize\\Repository\\CategoryRepository'] : $this->load('getCategoryRepositoryService.php')) && false ?: '_'});
