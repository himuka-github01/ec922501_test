...
// Returns the public 'Plugin\ProductOption\Controller\Admin\ProductOptionRankController' shared autowired service.
...
include_once $this->targetDirs[3].'/app/Plugin/ProductOption/Controller/Admin/ProductOptionRankController.php';

$this->services['Plugin\\ProductOption\\Controller\\Admin\\ProductOptionRankController'] = $instance = new \Plugin\ProductOption\Controller\Admin\ProductOptionRankController(${($_ = isset($this->services['Customize\\Repository\\ProductRepository']) ? $this->services['Customize\\Repository\\ProductRepository'] : $this->getProductRepositoryService()) && false ?: '_'}, ${($_ = isset($this->services['Plugin\\ProductOption\\Repository\\ProductOptionRepository']) ? $this->services['Plugin\\ProductOption\\Repository\\ProductOptionRepository'] : $this->load('getProductOptionRepositoryService.php')) && false ?: '_'});
