...
/* Entry/confirm.twig */
class __TwigTemplate_0649339d41c177b0dfc6e6159a2457ef233c8b9543f8bea4b302894e87783eb8 extends \Eccube\Twig\Template
{
    private $source;
    private $macros = [];
    ...
    public function block_main($context, array $blocks = [])
    {
        ...
        echo "
                    <p>";
        // line 26
        echo nl2br(twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans("front.entry.confirm_message"), "html", null, true));
        echo "</p>
        ...
        $context['_seq'] = twig_ensure_traversable(twig_array_filter((isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 134, $this->source); })()), function ($__f__) use ($context, $macros) { $context["f"] = $__f__; return twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, $context["f"], "vars", [], "any", false, false, false, 134), "eccube_form_options", [], "any", false, false, false, 134), "auto_render", [], "any", false, false, false, 134); }));
...
{% endblock %}
", "Entry/confirm.twig", "/var/www/htdocs/ec922501/src/Eccube/Resource/template/default/Entry/confirm.twig");
    }
}
