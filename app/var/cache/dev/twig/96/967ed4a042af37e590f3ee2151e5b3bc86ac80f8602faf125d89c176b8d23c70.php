...
class __TwigTemplate_f5f2fa41ba24b76044fbe01d57446b0399ee9d985f46c75b61964fab367d586c extends \Eccube\Twig\Template
{
    private $source;
    private $macros = [];
    ...
    <tbody>
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["key"]) {
            ...
            echo "</th>
                <td>";
            // line 12
            echo call_user_func_array($this->env->getFunction('profiler_dump')->getCallable(), [$this->env, twig_get_attribute($this->env, $this->source, (isset($context["data"]) || array_key_exists("data", $context) ? $context["data"] : (function () { throw new RuntimeError('Variable "data" does not exist.', 12, $this->source); })()), $context["key"], [], "array", false, false, false, 12)]);
            echo "</td>
            </tr>
        ";
        }
...
", "WebProfilerBundle:Profiler:table.html.twig", "/var/www/htdocs/ec922501/vendor/symfony/web-profiler-bundle/Resources/views/Profiler/table.html.twig");
    }
}
