...
class __TwigTemplate_3eee210eae163ed68869fd13e5197cd0e2372bda24598b22a11e504760c43bc7 extends \Eccube\Twig\Template
{
    private $source;
    private $macros = [];
...
";
    ...
    public function block_panel($context, array $blocks = [])
    {
        ...
        // line 12
        echo "    <h2>";
        (((isset($context["tokens"]) || array_key_exists("tokens", $context) ? $context["tokens"] : (function () { throw new RuntimeError('Variable "tokens" does not exist.', 12, $this->source); })())) ? (print (twig_escape_filter($this->env, twig_length_filter($this->env, (isset($context["tokens"]) || array_key_exists("tokens", $context) ? $context["tokens"] : (function () { throw new RuntimeError('Variable "tokens" does not exist.', 12, $this->source); })())), "html", null, true))) : (print ("No")));
        ...
        if ((isset($context["tokens"]) || array_key_exists("tokens", $context) ? $context["tokens"] : (function () { throw new RuntimeError('Variable "tokens" does not exist.', 14, $this->source); })())) {
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["result"]) {
                ...
                echo "
                            ";
                // line 44
                if ( !(null === twig_get_attribute($this->env, $this->source, (isset($context["request"]) || array_key_exists("request", $context) ? $context["request"] : (function () { throw new RuntimeError('Variable "request" does not exist.', 44, $this->source); })()), "session", [], "any", false, false, false, 44))) {
                    // line 45
                    echo "                                <a href=\"";
                    echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("_profiler_search_results", twig_array_merge(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, (isset($context["request"]) || array_key_exists("request", $context) ? $context["request"] : (function () { throw new RuntimeError('Variable "request" does not exist.', 45, $this->source); })()), "query", [], "any", false, false, false, 45), "all", [], "any", false, false, false, 45), ["method" => twig_get_attribute($this->env, $this->source, $context["result"], "method", [], "any", false, false, false, 45), "token" => twig_get_attribute($this->env, $this->source, $context["result"], "token", [], "any", false, false, false, 45)])), "html", null, true);
                    echo "\" title=\"Search\">
                                    <span title=\"Search\" class=\"sf-icon sf-search\">";
                    // line 46
                    echo twig_include($this->env, $context, "@WebProfiler/Icon/search.svg");
                ...
                echo "
                            ";
                // line 52
                if ( !(null === twig_get_attribute($this->env, $this->source, (isset($context["request"]) || array_key_exists("request", $context) ? $context["request"] : (function () { throw new RuntimeError('Variable "request" does not exist.', 52, $this->source); })()), "session", [], "any", false, false, false, 52))) {
                    // line 53
                    echo "                                <a href=\"";
                    echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("_profiler_search_results", twig_array_merge(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, (isset($context["request"]) || array_key_exists("request", $context) ? $context["request"] : (function () { throw new RuntimeError('Variable "request" does not exist.', 53, $this->source); })()), "query", [], "any", false, false, false, 53), "all", [], "any", false, false, false, 53), ["url" => twig_get_attribute($this->env, $this->source, $context["result"], "url", [], "any", false, false, false, 53), "token" => twig_get_attribute($this->env, $this->source, $context["result"], "token", [], "any", false, false, false, 53)])), "html", null, true);
                    echo "\" title=\"Search\">
                                    <span title=\"Search\" class=\"sf-icon sf-search\">";
                    // line 54
                    echo twig_include($this->env, $context, "@WebProfiler/Icon/search.svg");
...
";
    ...
    {
        return array (  251 => 72,  245 => 68,  240 => 65,  221 => 62,  216 => 60,  212 => 59,  208 => 57,  202 => 54,  197 => 53,  195 => 52,  191 => 51,  187 => 49,  181 => 46,  176 => 45,  174 => 44,  170 => 43,  166 => 41,  160 => 38,  155 => 37,  153 => 36,  149 => 35,  141 => 32,  136 => 29,  133 => 28,  116 => 27,  102 => 15,  100 => 14,  94 => 12,  84 => 11,  69 => 4,  59 => 3,  36 => 1,);
    }
...
{% endblock %}
", "WebProfilerBundle:Profiler:results.html.twig", "/var/www/htdocs/ec922501/vendor/symfony/web-profiler-bundle/Resources/views/Profiler/results.html.twig");
    }
}
