...
use Customize\Repository\OrderRepository;  //管理画面用　2024/10/31 田中
...
class SearchOrderTypeExtension extends AbstractTypeExtension
{
    ...
    protected $paymentRepository;
     ...
     //ここに管理画面用　受取日絞り込みを追記する　2024/10/31     　
     /**  
      *@var OrderRepository
      */
    ...
    public function __construct(
        ...
        OrderRepository $orderrepository, //管理画面（受取日検索用）　2024/10/31
        ...
        $this->OrderRepository = $orderrepository; //管理画面（受取日検索用）　2024/10/31
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        ...
        */
        ...
        //管理画面　Ukedate用Form 2024/10/31
        ->add('order_ukedate_start', DateType::class, [
            'label' => '受取日（開始）',
            'required' => false,
            'input' => 'datetime',
            'widget' => 'single_text',
            ...
            'attr' => [
                'class' => 'datepicker-input',
                'data-target' => '#'.$this->getBlockPrefix().'_order_ukedate_start',
                'data-toggle' => 'datepicker',
            ],
        ])
        ->add('order_ukedate_end', DateType::class, [
            'label' => '受取日(終了)',
            'required' => false,
            'input' => 'datetime',
            'widget' => 'single_text',
            ...
            'attr' => [
                'class' => 'datepicker-input',
                'data-target' => '#'.$this->getBlockPrefix().'_order_ukedate_end',
                'data-toggle' => 'datepicker',
            ],
        ])
        ;
